  ...
  return (
    <>
      <div>
        ...
        <div className="px-[8rem] py-20 bg-black text-white flex justify-center w-full">
          <div>
            <div className="flex justify-between items-center py-20">
              <div className="font-mono">
                <h1 className="text-[2.5rem] font-bold mb-10 ">
            ...
            <div className="flex justify-between items-center gap-20 py-20">
              ...
              <div className="font-mono">
                ...
                <p className="text-lg leading-7">
                  ...
                  design concept becomes a reality in the digital realm breaking
            ...
            <div className="flex justify-between items-center gap-20 py-20 ">
              <div className="font-mono">
                ...
                <p className="text-lg leading-7">
                  ...
                  blend creativity and technology to create unforgettable events
                  that transport viewers to new dimensions.!
                </p>
                <p className="mt-3 font-bold font-sans">
                  <span className="text-3xl">M</span>ore
                </p>
